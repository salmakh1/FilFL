...
from selection.bandits import rgl, optimized_rgl, check_submodularity, check_submodularity_percentage
    ...
    def train_clients(self):
        ...
        if self.cfg.use_wandb:
            ...
            run_name = "Clt" + "_" + str(
                ...
                self.cfg.datamodule.pub_size) + "_LR_" + str(self.cfg.optim.lr)
        ...
        for t in range(self.cfg.rounds):
            ...
            # if t == 1:
            # gamma, mean_gamma, percentile_75 , percentile_50, percentile_25  = check_submodularity(active_clients=active_clients,
            #                             local_weights=local_weights, model=self.model, device=self.device,
            #                             data=pub_data)

            submodularity_percentages = check_submodularity_percentage(active_clients=active_clients,
                local_weights=local_weights, model=self.model, device=self.device,
                data=pub_data)

            # wandb.log({'submodular/gamma_mean': mean_gamma,
            #            'submodular/gamma_percentile_75': percentile_75,
            #            'submodular/gamma_percentile_50': percentile_50,
            #            'submodular/gamma_percentile_25': percentile_25,
            #            },
            #           step=t)

            log.info(" submodularity_percentages {} in round {}".format(submodularity_percentages, t))

            wandb.log({'submodular/submodularity_percentages': submodularity_percentages,
                       },
                      step=t)
